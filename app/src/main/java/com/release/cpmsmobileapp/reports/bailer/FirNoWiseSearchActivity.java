...
import com.release.cpmsmobileapp.databinding.ActivityFirNoWiseSearchBinding;
...
public class FirNoWiseSearchActivity extends AppCompatActivity {

    private ActivityFirNoWiseSearchBinding binding;
    private View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFirNoWiseSearchBinding.inflate(getLayoutInflater());
    ...
    private void setRecyclerView() {
        binding.resultRv.setLayoutManager(new LinearLayoutManager(FirNoWiseSearchActivity.this));
        adapter = new BailerReportAdapter(1);
    ...
    private void searchFunc() {
        ...
        BailerReportRequestBody requestBody = new BailerReportRequestBody(gpfNo, userDistrictId, firNo, year, districtID, stationID);
        ...
        call.enqueue(new Callback<List<BailerReportResponse>>() {
            ...
            public void onResponse(Call<List<BailerReportResponse>> call, Response<List<BailerReportResponse>> response) {
                ...
                if (response.body() == null) {
                    ...
                    Toast.makeText(FirNoWiseSearchActivity.this, "Could not get details for this case", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (model.size() != 0) {
                    binding.txtSearch.setVisibility(View.VISIBLE);
...
//                    BailerReportResponse caseResponse = response.body().get(0);
                    adapter.setBailerReportAdapter(model, FirNoWiseSearchActivity.this);
...
//                    binding.resultCard.setVisibility(View.GONE);
                    Toast.makeText(FirNoWiseSearchActivity.this, "No details found", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void setYearSpinnerAdapter(){
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(FirNoWiseSearchActivity.this, R.layout.drop_down_item_layout,yearsDropdown);
...
//                        idx = 0;
                        Toast.makeText(FirNoWiseSearchActivity.this, "District list is null", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
//                    idx = 0;
                    Toast.makeText(FirNoWiseSearchActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
//                distSpinner.setSelection(idx);
            ...
            public void onFailure(Call<List<DistrictResponse>> call, Throwable t) {
                Toast.makeText(FirNoWiseSearchActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void setDistSpinnerAdapter() {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(FirNoWiseSearchActivity.this, R.layout.drop_down_item_layout, distDropdown);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onResponse(Call<List<PsResponse>> call, Response<List<PsResponse>> response) {
                ...
                try {
                    if (psList != null) {
                        ...
                        Toast.makeText(FirNoWiseSearchActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(FirNoWiseSearchActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    private void setPsSpinnerAdapter() {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(FirNoWiseSearchActivity.this, R.layout.drop_down_item_layout, psDropdown);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
