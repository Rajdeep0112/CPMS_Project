...
public class FirNoWiseAbsenteeReport extends AppCompatActivity {

    private ActivityFirNoWiseAbsenteeReportBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFirNoWiseAbsenteeReportBinding.inflate(getLayoutInflater());
    ...
    private void searchFunc() {
        ...
        AbsenteeRequestBody requestBody = new AbsenteeRequestBody(gpfNo, userDistrictId, firNo, year, districtID, stationID);
        ...
        call.enqueue(new Callback<List<AbsenteeResponse>>() {
            ...
            public void onResponse(Call<List<AbsenteeResponse>> call, Response<List<AbsenteeResponse>> response) {
                ...
                if (response.body() == null) {
                    ...
                    Toast.makeText(FirNoWiseAbsenteeReport.this, "Could not get details for this case", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (model.size() != 0) {
                    binding.txtSearch.setVisibility(View.VISIBLE);
...
//                    BailerReportResponse caseResponse = response.body().get(0);
                    adapter.setAbsenteeWitnessWiseAdapter(model, FirNoWiseAbsenteeReport.this);
...
//                    binding.resultCard.setVisibility(View.GONE);
                    Toast.makeText(FirNoWiseAbsenteeReport.this, "No details found", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void setRecyclerView() {
        binding.absenteeWitnessWiseRv.setLayoutManager(new LinearLayoutManager(FirNoWiseAbsenteeReport.this));
    ...
    private void setYearSpinnerAdapter(){
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(FirNoWiseAbsenteeReport.this, R.layout.drop_down_item_layout,yearsDropdown);
...
//                        idx = 0;
                        Toast.makeText(FirNoWiseAbsenteeReport.this, "District list is null", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
//                    idx = 0;
                    Toast.makeText(FirNoWiseAbsenteeReport.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
//                distSpinner.setSelection(idx);
            ...
            public void onFailure(Call<List<DistrictResponse>> call, Throwable t) {
                Toast.makeText(FirNoWiseAbsenteeReport.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void setDistSpinnerAdapter() {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(FirNoWiseAbsenteeReport.this, R.layout.drop_down_item_layout, distDropdown);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onResponse(Call<List<PsResponse>> call, Response<List<PsResponse>> response) {
                ...
                try {
                    if (psList != null) {
                        ...
                        Toast.makeText(FirNoWiseAbsenteeReport.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(FirNoWiseAbsenteeReport.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    private void setPsSpinnerAdapter() {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(FirNoWiseAbsenteeReport.this, R.layout.drop_down_item_layout, psDropdown);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
